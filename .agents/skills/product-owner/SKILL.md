...
| Milestone Overview & Progress | `docs/product/milestones/[n]-[title]/milestone.md` |
| New Task Creation | `docs/product/milestones/[n]-[title]/[order]-[title].task.md` |
...
3. **Task Generation** — Create a new file: `docs/product/milestones/[n]-[title]/[order]-[title].task.md`.
