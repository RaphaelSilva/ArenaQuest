...
`docs/product/milestones/2-authentication-and-user-management/closeout-analysis.md §6`.
...
- [ ] Annotate `docs/product/milestones/2-authentication-and-user-management/closeout-analysis.md §6` per row with the
