...
> (see `docs/product/milestones/2-authentication-and-user-management/closeout-analysis.md`). This story groups every
...
- **Origin document:** `docs/product/milestones/2-authentication-and-user-management/closeout-analysis.md §6`
...
- `docs/product/milestones/2-authentication-and-user-management/closeout-analysis.md §6` is annotated per-row with the PR or
