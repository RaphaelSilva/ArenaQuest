...
**Date:** 2026-06-17
**Status of this doc:** Open — blocks promoting RFC 0005 from "Implemented".
...
|---|----------|------|--------|
| 1 | 🟠 Functional | No navigation entry to reach `/admin/access` | Open |
| 2 | 🟠 Functional | No group create/CRUD → group grants are unusable end-to-end | Open |
| 3 | 🟡 Inconsistency | Stale "Enrollments" action on the **users list** page | Open |
