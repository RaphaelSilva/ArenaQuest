...
|---|-----------|-------|------|--------|
| 01 | [Fix wrangler-action typo in prod CI jobs](./01-fix-wrangler-action-typo-in-prod-ci-jobs.task.md) | 0 | Backend | 📝 Open |
| 02 | [Cloud-agnostic core and Cloudflare adapter with preflight and dry-run](./02-cloud-agnostic-core-and-cloudflare-adapter-with-pr.task.md) | 1 | Backend | 📝 Open |
