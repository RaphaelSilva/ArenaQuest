...
export function StatCardLevel({ xp }: Props) {
  ...
  return (
    <article
      ...
      aria-label={dict.dashboard.levelCard.ariaLabel}
    >
      ...
      <div className="mb-3 flex items-center justify-between">
        <span className="text-[11px] font-semibold uppercase tracking-widest" style={{ color: 'var(--aq-text3)' }}>
          {dict.dashboard.levelCard.label}
        </span>
        <span
      ...
      <div className="flex items-end gap-3">
        ...
        <div className="mb-1">
          ...
          <p className="text-[11px]" style={{ color: 'var(--aq-text3)' }}>
            {dict.dashboard.levelCard.xpTotal(xp.totalXp)}
          </p>
        </div>
      </div>
      ...
      <div className="mt-3 space-y-1">
        <div className="flex justify-between text-[11px]" style={{ color: 'var(--aq-text3)' }}>
          ...
          <span>{dict.dashboard.levelCard.xpToNext(xp.xpToNextLevel)}</span>
        </div>
        <div
          className="h-2 overflow-hidden rounded-full"
          style={{ background: 'var(--aq-bg4)' }}
          role="progressbar"
          aria-label={dict.dashboard.levelCard.xpProgressLabel}
          aria-valuenow={pct}
          aria-valuemin={0}
          aria-valuemax={100}
        >
