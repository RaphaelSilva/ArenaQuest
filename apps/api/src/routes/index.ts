...
export class AppRouter {
  ...
  static register(
    ...
    const { auth, users, tokens, topics, tags, media, storage, authService, loginLimiter, registerController, registerLimiter, cookieSameSite, allowedOrigins, strictCors } = deps;
    ...
    // Feature routes
    app.route('/auth', buildAuthRouter({ authService, loginLimiter, cookieSameSite, registerController, registerLimiter }));
